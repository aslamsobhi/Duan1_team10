                            ...
                            <div class="row">
                                <div class="form__group col-12">
                                    ...
                                    <textarea class="form__input form__input--textarea" id="orderNotes"
                                        name="orderNotes"
                                        placeholder="Ghi chú về đơn hàng của bạn, ví dụ ghi chú đặc biệt về đơn hàng của bạn ."></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <form action="#" class="payment-form">
                                <div class="payment-group mb--10">
                                    ...
                                    <div class="payment-info" data-method="bank">
                                        <p>Thanh toán trực tiếp vào tài khoản ngân hàng của chúng tôi. Vui lòng sử dụng
                                            Mã đơn hàng của bạn làm tham chiếu thanh toán. Đơn hàng của bạn sẽ không
                                            được giao cho đến khi tiền được chuyển vào tài khoản của chúng tôi.</p>
                                    </div>
                                </div>
